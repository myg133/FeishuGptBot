...
export class IoContainer {
  ...
  private parent?: IoContainer;
  private constructor(parent?: IoContainer) {
  ...
  AddTypeSingleton<T extends Function>(clazz: T) {
    if (typeof clazz != "function") {
      throw new Error(
        "Please use AddSingleton for register a instance of Class",
      );
    }
    // 检查是否已注册
    if (this.isAdded(clazz)) {
  ...
  AddTypeScoped<T extends Function>(clazz: T) {
    if (typeof clazz != "function") {
  ...
  AddTypeTransient<T extends Function>(clazz: T) {
    if (typeof clazz != "function") {
  ...
  AsSingleton(): IoContainer {
    if (this.parent == undefined || this.parent == null) {
      return this;
    }
    let p = this.parent;
    this.scoped.forEach((clazz) => {
      p.AddTypeSingleton(clazz);
    });
    delete this;
    return p;
  }
  AsScoped(): IoContainer {
    if (this.parent == undefined || this.parent == null) {
      return this;
    }
    let p = this.parent;
    this.scoped.forEach((clazz) => {
      p.AddTypeScoped(clazz);
    });
    delete this;
    return p;
  }
  AsTransient(): IoContainer {
    if (this.parent == undefined || this.parent == null) {
      return this;
    }
    let p = this.parent;
    this.scoped.forEach((clazz) => {
      p.AddTypeTransient(clazz);
    });
    delete this;
    return p;
  }
